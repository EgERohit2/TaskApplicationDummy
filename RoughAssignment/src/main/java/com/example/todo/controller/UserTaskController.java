...
//	        Optional<UserTask> optionalTask = userTaskServiceImplementation.getUserTaskById(id);
//	        if (optionalTask.isPresent()) {
//	        	UserTask t = new Task();
//	        	t.setId(optionalTask.get().getId());
//	           // UserTask usertask = optionalTask.get().getId();
//	            Date currentDate = new Date();
//	            if (currentDate.after(t.getEndDate())) {
//	            	t.setStatus(TaskStatus.OVERDUE);
//	            } else {
//	            	t.setStatus(TaskStatus.INPROGRESS);
//	            }
//	            userTaskServiceImplementation.saveUserTask(t);
